...
<div id="right-panel" class="right-panel">
	...
	while($d = mysqli_fetch_array($data)){
		?>
                    <form action="editberita.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                    <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Id</label></div>
                            <div class="col-12 col-md-9"><input type="text"  name="judul" value="<?php echo $d['id']; ?>" class="form-control"></div>
                        </div>  
                    <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Judul</label></div>
                            <div class="col-12 col-md-9"><input type="text"  name="judul" value="<?php echo $d['judul']; ?>" class="form-control"></div>
                        </div>
                        <div class="row form-group">
                                <div class="col col-md-3"><label for="file-input" class=" form-control-label">Masukkan Gambar</label></div>
                                <div class="col-12 col-md-9"><input type="file" name="gambar" value="<?php echo $d['gambar']; ?>" class="form-control-file"></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Isi Berita</label></div>
                            <div class="col-12 col-md-9"><textarea name="berita" rows="9" value="<?php echo $d['berita']; ?>" class="form-control"></textarea></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Tanggal</label></div>
                            <div class="col-12 col-md-9"><input type="date" name="tanggal" rows="9"  value="<?php echo $d['tanggal']; ?>"class="form-control"></div>
                        </div>
