                                            ...
                                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                          <a href="edit-admin.php?id=<?php echo $d['id']; ?>"><button class="btn btn-primary">EDIT</button></a>
					                                      <a href="deleteadmin.php?id=<?php echo $d['id']; ?>"><button class="btn btn-danger"> HAPUS</button> </a>
                                                        </td>
                                                    </tr>
                                                    <?php 
		                                                }
